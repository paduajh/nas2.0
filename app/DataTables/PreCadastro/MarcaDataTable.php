...
class MarcaDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'precadastro.marcas.datatables_actions');
    }
    ...
    {
        return [
            'nome' => new Column(['title' => __('models/marcas.fields.nome'), 'data' => 'nome']),
            'descricao' => new Column(['title' => __('models/marcas.fields.descricao'), 'data' => 'descricao'])
        ];
    }

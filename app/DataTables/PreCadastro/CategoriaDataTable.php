...
class CategoriaDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'precadastro.categorias.datatables_actions');
    }
    ...
    {
        return [
            'nome' => new Column(['title' => __('models/categorias.fields.nome'), 'data' => 'nome']),
            'descricao' => new Column(['title' => __('models/categorias.fields.descricao'), 'data' => 'descricao'])
        ];
    }
